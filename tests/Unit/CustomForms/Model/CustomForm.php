...
test('is_template property is equals to template_identifier == null', function () {
    ...
    expect($customFormNoTemplate->template_identifier)->toBeNull();

    //Template
    expect($customFormTemplate->is_template)->toBeTrue();
    expect($customFormTemplate->template_identifier)->not->toBeNull();
});
