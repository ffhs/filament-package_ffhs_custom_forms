...
class CustomFieldAdder extends FormEditorFieldAdder
{
    ...
    function getSchema(): array {
        ...
        foreach ($types as $type) {
            $modalWidth  = EditCustomFieldAction::getEditCustomFormActionModalWith(["type" => $type::getFieldIdentifier()]);
            ...
            $actions[] = Actions::make([
                Action::make("add_".$type::getFieldIdentifier()."_action")
                    ...
                    ->form(function() use ($type) {
                        ...
                        return EditCustomFieldForm::getCustomFieldSchema($state,$this->form);
                    })
