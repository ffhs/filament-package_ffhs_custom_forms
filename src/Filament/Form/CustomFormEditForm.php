...
class CustomFormEditForm
{
    ...
    private static function getFieldAddSchema():array {
        return [
            //GeneralField
            Placeholder::make("")
            ...
            Select::make("add_general_field_id")
                ->label("")
                ->live()
                ->disableOptionWhen(fn($value, $get) =>in_array($value, self::getUsedGeneralFieldIds($get("custom_fields"))))
