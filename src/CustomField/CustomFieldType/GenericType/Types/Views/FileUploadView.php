...
class FileUploadView implements FieldTypeView
{
    ...
    public static function prepareFileUploadComponent(FileUpload $component, CustomField $record): FileUpload
    {
    ...
    public static function getInfolistComponent(
        ...
        if (FieldMapper::getOptionParameter($record, "image") && FieldMapper::getOptionParameter(
                $record,
                "show_images_in_view"
            )) {
    ...
    public static function getInfolistImageComponent(
        mixed $files,
        mixed $diskRoot,
        CustomFieldAnswer $record,
        mixed $names
    ...
    public static function getDownloadInfolistAction(
        mixed $path,
        CustomFieldAnswer $record,
        string $absolutePath,
        $names
    ...
    public static function getInfoListFiles(
        mixed $files,
        mixed $diskRoot,
        CustomFieldAnswer $record,
        mixed $names
